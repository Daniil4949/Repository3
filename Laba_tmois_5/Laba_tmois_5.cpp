...
int main()
{
	...
	//menu();
	cout << "Введите мощность области отправления соответствия Г1: " << endl;
	int n1;
	cin >> n1;
	int* X_1 = new int[n1];
	...
	cout << "Введите мощность области прибытия соответствия Г1: " << endl;
	int m1;
	cin >> m1;
	int* Y_1 = new int[m1];
	cout << "Введите элементы множества: " << endl;
	...
	cout << "Область отправления соответствия Г1:\t"; WatchMn(X, X[0]); cout << endl;
	cout << "Область прибытия    соответствия Г1:\t"; WatchMn(Y, Y[0]); cout << endl;
	cout << "Введите мощность графика F соответствия Г1:\t";
	...
	cout << "Введите мощность области отправления соответствия Г2: " << endl;
	int n2;
	cin >> n2;
	int* U_1 = new int[n2];
	cout << "Введите элементы множества: " << endl;
	...
	cout << "Введите мощность области прибытия соответствия Г2: " << endl;
	int m2;
	cin >> m2;
	int* V_1 = new int[m2];
	cout << "Введите элементы множества: " << endl;
	...
	cout << "Область отправления соответствия Г2:\t"; WatchMn(U, U[0]); cout << endl;
	cout << "Область прибытия    соответствия Г2:\t"; WatchMn(V, V[0]); cout << endl;
	cout << "Введите мощность графика G соответствия Г2:\t";
	int mF;
	...
	{
		system("cls");
		cout << "Г1 = <";	WatchMn(X, X[0]); cout << ", "; WatchMn(Y, Y[0]); cout << ", "; Watch(G, mG); cout << ">" << endl;
		cout << "Г2 = <";	WatchMn(U, U[0]); cout << ", "; WatchMn(V, V[0]); cout << ", "; Watch(F, mF);  cout << ">" << endl;
		menu();
		...
		system("cls");
		cout << "Г1 = <";	WatchMn(X, X[0]); cout << ", "; WatchMn(Y, Y[0]); cout << ", "; Watch(G, mG); cout << ">" << endl;
		cout << "Г2 = <";	WatchMn(U, U[0]); cout << ", "; WatchMn(V, V[0]); cout << ", "; Watch(F, mF);  cout << ">" << endl << endl;
		switch (Operaziya)
		{
		case 1: //  25  Нахождение пересечения соответствий 
		{
		...
		break;
		case 2: //  26  Нахождение объединения соответствий 
		{
		...
		//}
		//break;
		case 4: //  31  Нахождение симметрической разности соответствий A и B:
		{
		...
		break;
		case 6: //  32  Нахождение композиции соответствий A и B:
		{
		...
		case 7:
		{
			cout << "Дополнение соответствия Г1 до универсума : " << endl;
			int mK = X[0] * Y[0] + 1;
			...
			for (int i = 0; i <= mC; i++)
				C[i] = new int[3];
			C = Dop(F, G, mF, mG);	// 26.1  Нахождение объединения графиков G и F:
			mC = C[0][0];
		...
		//}
		//break;
		case 8://  34  Нахождение образа соответствия A:
		{
			int mR = (Y[0] * mG / 2);
		...
		break;
		case 9://  35  Нахождение прообраза соответствия A:
		{
			int mZ = (Y[0] * mG);
		...
		//}
		//break;
		case 10://  38  Нахождение сужения соответствия A: 
		{
			int mE = mG + Y[0] * Y[0];
			int** E = new int* [mE];
			for (int i = 1; i <= mE; i++)
...
void  menu()
{
	...
	cout << "	1.  Пересечение соответствий.\n	2.  Объединение соответствий.\n	3.  Разность соответствий.\n        4.	Симметрическая разность соответствий.\n	5.  Инверсия соответствия Г1.\n";
	cout << "	\n	6.   Композиция соответствий Г1 и Г2.\n ";
	/*cout << "       7.   Дополнение до универсума соответствия Г1\n" << endl;*/
	cout << "	8.  Образ Г1.\n	9. Прообраз А.\n	\n	10. Cужение А.\n";
	cout << "	0.  Выход.\n";
	cout << "-->";
}
